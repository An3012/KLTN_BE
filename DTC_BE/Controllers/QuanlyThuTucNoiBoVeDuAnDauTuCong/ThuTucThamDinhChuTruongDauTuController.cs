...
namespace DTC_BE.Controllers.QuanlyThuTucNoiBoVeDuAnDauTuCong
{
    ...
    [ApiController]
    public class ThuTucThamDinhChuTruongDauTuController : BaseApiController
    {
        #region ByListAll Thutucthamdinh
        [Route("getAllDanhMucThuTucThamDinhChuTruongDauTu")]
        [HttpPost]
        public ResponseMessage GetAllDanhMucThuTucThamDinhChuTruongDauTu(TimKiemTTTDModels TimKiemThuTuc)
        {
            try
            {
                ...
                var query = context.QuanLyThuTucNoiBoDuAnDtcs
                    ...
                    .Where(s =>
                        ...
                        && s.LoaiHoSo == (int)Enums.LoaiThuTuNoiBoDuAnDTC.ThuTucThamDinhchuTruongDauTu
