...
namespace DTC_BE.Controllers.QuanlyThuTucNoiBoVeDuAnDauTuCong
{
    ...
    [ApiController]
    public class ThuTucThamDinhDuToanDuAnDTKhongCoCPXDController : BaseApiController
    {
        #region ByListAll Thutucthamdinh
        [Route("GetThuTucThamDinhDuToanDuAnDTKhongCoCPXD")]
        [HttpPost]
        public ResponseMessage GetThuTucThamDinhDuToanDuAnDTKhongCoCPXD(TimKiemTTTDModels TimKiemThuTuc)
        {
            try
            {
                ...
                var query = context.QuanLyThuTucNoiBoDuAnDtcs
                    ...
                    .Where(s =>
                        ...
                        && s.LoaiHoSo == (int)Enums.LoaiThuTuNoiBoDuAnDTC.ThuTucThamDinhDuToanDuAnDauTuKhongCoCauPhanXayDung
