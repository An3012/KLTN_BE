...
namespace DTC_BE.Controllers.QuanlyThuTucNoiBoVeDuAnDauTuCong
{
    ...
    [ApiController]
    public class ThuTucThamDinhDCDuAnDTCoCPXDController : BaseApiController
    {
        [Route("getDMThuTucThamDinhDCDuAnDTCoCPXD")]
        [HttpPost]
        public ResponseMessage GetDMThuTucThamDinhDCDuAnDTCoCPXD(TimKiemTTTDModels TimKiemThuTuc)
        {
            try
            {
                ...
                var query = context.QuanLyThuTucNoiBoDuAnDtcs
                    ...
                    .Where(s =>
                        ...
                        && s.LoaiHoSo == (int)Enums.LoaiThuTuNoiBoDuAnDTC.ThamDinhDieuChinhDuAnDauTuCoCauPhanXayDung
