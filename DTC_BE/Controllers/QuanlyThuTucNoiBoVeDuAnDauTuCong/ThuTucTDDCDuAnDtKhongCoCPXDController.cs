...
namespace DTC_BE.Controllers.QuanlyThuTucNoiBoVeDuAnDauTuCong
{
    ...
    [ApiController]
    public class ThuTucTDDCDuAnDtKhongCoCPXDController : BaseApiController
    {
        [Route("GetAllDanhMucThuTucTDDCDuAnDtKhongCoCPXD")]
        [HttpPost]
        public ResponseMessage GetAllDanhMucThuTucTDDCDuAnDtKhongCoCPXD(TimKiemTTTDModels TimKiemThuTuc)
        {
            try
            {
                ...
                var query = context.QuanLyThuTucNoiBoDuAnDtcs
                    ...
                    .Where(s =>
                        ...
                        && s.LoaiHoSo == (int)Enums.LoaiThuTuNoiBoDuAnDTC.ThuTucThamDinhDieuChinhDuAnDauTuKhongCoCauPhanXayDung
