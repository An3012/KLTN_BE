...
namespace DTC_BE.Controllers.QuanlyThuTucNoiBoVeDuAnDauTuCong
{
    ...
    [ApiController]
    public class ThuTucThamDinhDieuChinhDuToanDuAnDTKhongCoCPXDController : BaseApiController
    {
        #region ByListAll Thutucthamdinh
        [Route("GetThuTucTDDieuChinhDuToanDuAnDTKhongCoCPXD")]
        [HttpPost]
        public ResponseMessage GetThuTucTDDieuChinhDuToanDuAnDTKhongCoCPXD(TimKiemTTTDModels TimKiemThuTuc)
        {
            try
            {
                ...
                var query = context.QuanLyThuTucNoiBoDuAnDtcs
                    ...
                    .Where(s =>
                        ...
                        && s.LoaiHoSo == (int)Enums.LoaiThuTuNoiBoDuAnDTC.ThuTucThamDinhDuToanDieuChinhDuAnDauTuKhongCoCauPhanXayDung
