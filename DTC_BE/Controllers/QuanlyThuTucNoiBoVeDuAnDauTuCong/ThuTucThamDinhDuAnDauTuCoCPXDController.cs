...
namespace DTC_BE.Controllers.QuanlyThuTucNoiBoVeDuAnDauTuCong
{
    ...
    [ApiController]
    public class ThuTucThamDinhDuAnDauTuCoCPXDController : BaseApiController
    {
        #region ByListAll Thutucthamdinh
        [Route("GetDanhMucThuTucThamDinhDuAnDauTuCoCauPhanXayDung")]
        [HttpPost]
        public ResponseMessage GetDanhMucThuTucThamDinhDuAnDauTuCoCauPhanXayDung(TimKiemTTTDModels TimKiemThuTuc)
        {
            try
            {
                ...
                var query = context.QuanLyThuTucNoiBoDuAnDtcs
                    ...
                    .Where(s =>
                        ...
                        && s.LoaiHoSo == (int)Enums.LoaiThuTuNoiBoDuAnDTC.ThamDinhDuAnDauTuCoCauPhanXayDung
