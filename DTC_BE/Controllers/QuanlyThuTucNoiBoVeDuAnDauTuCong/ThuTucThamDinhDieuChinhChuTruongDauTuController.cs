...
namespace DTC_BE.Controllers.QuanlyThuTucNoiBoVeDuAnDauTuCong
{
    ...
    [ApiController]
    public class ThuTucThamDinhDieuChinhChuTruongDauTuController : BaseApiController
    {
        [Route("GetAllDanhMucThuTucThamDinhDieuChinhChuTruongDauTu")]
        [HttpPost]
        public ResponseMessage GetAllDanhMucThuTucThamDinhDieuChinhChuTruongDauTu(TimKiemTTTDModels TimKiemThuTuc)
        {
            try
            {
                ...
                var query = context.QuanLyThuTucNoiBoDuAnDtcs
                    ...
                    .Where(s =>
                        ...
                        && s.LoaiHoSo == (int)Enums.LoaiThuTuNoiBoDuAnDTC.ThamDinhDieuchinhChuTruongDauTu
