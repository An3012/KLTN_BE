...
namespace DTC_BE.Controllers.QuanlyThuTucNoiBoVeDuAnDauTuCong
{
    ...
    [ApiController]
    public class ThuTucTDDADauTuKhongCoCPXDController : BaseApiController
    {
        [Route("GetAllDanhMucThuTucTDDuAnDtKhongCoCPXD")]
        [HttpPost]
        public ResponseMessage GetAllDanhMucThuTucTDDuAnDtKhongCoCPXD(TimKiemTTTDModels TimKiemThuTuc)
        {
            try
            {
                ...
                var query = context.QuanLyThuTucNoiBoDuAnDtcs
                    ...
                    .Where(s =>
                        ...
                        && s.LoaiHoSo == (int)Enums.LoaiThuTuNoiBoDuAnDTC.ThamDinhDuAnDauTuKhongCoCauPhanXayDung
