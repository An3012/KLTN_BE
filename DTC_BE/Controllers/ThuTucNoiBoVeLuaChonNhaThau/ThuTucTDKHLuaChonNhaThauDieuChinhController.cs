...
namespace DTC_BE.Controllers.ThuTucNoiBoVeLuaChonNhaThau
{
    ...
    [ApiController]
    public class ThuTucTDKHLuaChonNhaThauDieuChinhController : BaseApiController
    {
        [Route("GetAllDMThuTucTDKHLCNhaThauDieuChinh")]
        [HttpPost]
        public ResponseMessage GetAllDMThuTucTDKHLCNhaThauDieuChinh(TimKiemTTTDModels TimKiemThuTuc)
        {
            try
            {
