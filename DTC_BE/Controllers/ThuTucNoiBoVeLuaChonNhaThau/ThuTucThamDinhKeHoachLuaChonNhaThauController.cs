...
using static DTC_BE.Models.ThuTucNBKeHoachLuaChonNhaThau.HoSoThuTucLuaChonNhaThau;
...
namespace DTC_BE.Controllers.ThuTucNoiBoVeLuaChonNhaThau
{
    ...
    [ApiController]
    public class ThuTucThamDinhKeHoachLuaChonNhaThauController : BaseApiController
    {
        [Route("GetAllDanhMucThuTucTDKeHoachLCNhaThau")]
        [HttpPost]
        public ResponseMessage GetAllDanhMucThuTucTDKeHoachLCNhaThau(TimKiemTTTDModels TimKiemThuTuc)
        {
            try
            {
